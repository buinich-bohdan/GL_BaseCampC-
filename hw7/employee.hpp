...
public:
    AbstractEmployee();
    AbstractEmployee(const std::string&, const std::string&, const std::string&);
...
std::ostream& operator<<(std::ostream& os, const AbstractEmployee& e); // prints first name & last name
